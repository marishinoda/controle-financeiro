...
* `controle_financeiro` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `controle_financeiro` - executable or bundle name on disk.
* `controle_financeiro` - display name shown in window titles and about app dialogs.
